if(Meteor.isServer){
  Accounts.emailTemplates.siteName = "Galaxy VR";
  Accounts.emailTemplates.from = "Galaxy <noreply@pos.galaxyvrcafe.com>";
						...
						<tr>
							<td align="center">
								<table class="col-600" width="600" border="0" align="center" cellpadding="0" cellspacing="0">
									<tbody>
										<tr>
											<td align="center" valign="top" background="https://galaxyvrcafe.com/hero.webp" bgcolor="#0000"
														...
														<tr>
															<td align="center" style="line-height: 0px;">
																<img style="display:block; line-height:0px; font-size:0px; border:0px;"
																	src="https://galaxyvrcafe.com/logos/white.png" width="200" height="97" alt="logo">
															</td>
														</tr>
													...
													<tbody>
														...
														<tr>
															<td align="center"
																style="font-family: 'Raleway', sans-serif; font-size:37px; color:#ffffff; line-height:24px; font-weight: bold; letter-spacing: 7px;">
																WELCOME TO <span
																	style="font-family: 'Raleway', sans-serif; font-size:37px; color:#ffffff; line-height:39px; font-weight: 300; letter-spacing: 7px;">VR
																	</span>
															</td>
														</tr>
