...
sourAlert = (data, callback) => {
  ...
  $("body").prepend(`
    <div class="sour-alert">
      ...
      <div class="buttons">
        <button type="button" id="sourAlertOK" style="background:#425F8B; color:#ffff; display: none;" class="btn my-4 mx-4">OK</button>
        <button type="button" id="sourAlertRemove" style="display: none;" class="btn btn-danger my-4 mx-4">Remove</button>
        <button type="button" id="sourAlertCancel" style="background:#425F8B; color:#ffff;
        display: none;" class="btn my-4 mx-4">Cancel</button>
      </div>
    </div>
  `);
  ...
  switch (data.type) {
    case "success": {
      $(".sour-alert .title").css("color", "#425F8B");
